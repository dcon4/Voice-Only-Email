...
/**
 * Provides Bible text from bible-api.com with offline disk cache.
 * Supports 6 translations: ASV, BBE, KJV, WEB, YLT, OEB-US.
 */
@Singleton
class BibleRepository @Inject constructor(
    ...
    suspend fun getChapterText(bookId: String, chapter: Int, bookName: String): String {
        ...
        // Try disk cache (from previous API calls)
